...
horizontal.addEventListener("input", (e) => {
  ...
  boxShadow.updatedValue('horizontal', value);
});

vertical.addEventListener("input", (e) => {
  const value = e.target.value

  boxShadow.updatedValue('vertical', value);
});

blur.addEventListener("input", (e) => {
  const value = e.target.value

  boxShadow.updatedValue('blur', value);
});

spread.addEventListener("input", (e) => {
  const value = e.target.value

  boxShadow.updatedValue('spread', value);
});

color.addEventListener("input", (e) => {
  const value = e.target.value

  boxShadow.updatedValue('color', value);
});

opacity.addEventListener("input", (e) => {
  const value = e.target.value

  boxShadow.updatedValue('opacity', value);
});

inset.addEventListener("input", (e) => {
  const value = e.target.checked

  boxShadow.updatedValue('inset', value);
});
